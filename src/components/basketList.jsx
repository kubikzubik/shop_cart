...
function BasketList(props) {
    ...
    return (
        <ul className="collection basket-list">
            <li className="collection-item active #1565c0 blue-grey"><h5>Корзина</h5></li>
            {order.length ? (
            ...
            <li className="collection-item active #1565c0 blue-grey"><h5>Общая стоимость заказа: {totalPrice} р</h5></li>
